                ...
                <ul className="slds-accordion">
                    <li className="slds-accordion__list-item">
                        <section className="slds-accordion__section slds-is-open">
                                ...
                                <h3 className="slds-accordion__summary-heading">
                                    <button aria-controls="accordion-details-01" aria-expanded="true"
                                        ...
                                        <svg
                                            ...
                                            aria-hidden="true">
                                            <use href="http://www.w3.org/1999/xlink"
                                                 href="/assets/icons/utility-sprite/svg/symbols.svg#switch"/>
                                        </svg>
                                        <span className="slds-truncate"
                                              title="Accordion summary">Accordion summary</span>
                                    </button>
                                </h3>
                                <div className="slds-dropdown-trigger slds-dropdown-trigger_click">
                                    <button
                                        ...
                                        <svg className="slds-button__icon" aria-hidden="true">
                                            <use href="http://www.w3.org/1999/xlink"
                                                 href="/assets/icons/utility-sprite/svg/symbols.svg#down"/>
                                        </svg>
                                    ...
                                    <div className="slds-dropdown slds-dropdown_actions slds-dropdown_right">
                                        <ul className="slds-dropdown__list" role="menu">
                                            ...
                                            <li className="slds-dropdown__item" role="presentation">
                                                <a href="javascript:void(0);" role="menuitem" tabIndex="-1">
                                                    <span className="slds-truncate"
                                                          title="Action Three">Action Three</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div aria-hidden="false" className="slds-accordion__content"
                                 id="accordion-details-01">Accordion
                                details - A
                            </div>
                        </section>
                    </li>
                    <li className="slds-accordion__list-item">
                        <section className="slds-accordion__section">
                            ...
                            <div aria-hidden="true" className="slds-accordion__content"
                                 id="accordion-details-02">Accordion
                                details - B
                            </div>
                        </section>
                    </li>
                    <li className="slds-accordion__list-item">
                        <section className="slds-accordion__section">
                            ...
                            <div aria-hidden="true" className="slds-accordion__content"
                                 id="accordion-details-03">Accordion
                                details - C
                            </div>
                        </section>
                    </li>
